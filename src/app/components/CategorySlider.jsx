...
const Categories = () => {
    ...
    return (
      <div className='flex fixed top-[85px] left-0 w-full bg-white pt-7 justify-evenly items-center min-h-[120px]'>
        <div>
        ...
        <div className='md:flex hidden gap-2 items-center justify-between px-6 py-4 rounded-2xl border-2 text-sm font-semibold'>
